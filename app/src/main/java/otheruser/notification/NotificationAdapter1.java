...
public class NotificationAdapter1 extends RecyclerView.Adapter<NotificationAdapter.ViewHolder> {
    private Context mContext;
    private List<OtheruserNotification1> mNotificationList;
    ...
    public NotificationAdapter1(List<OtheruserNotification1> notificationList){
    ...
    public NotificationAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                OtheruserNotification1 notification=mNotificationList.get(position);
    ...
    public void onBindViewHolder(NotificationAdapter.ViewHolder holder, int position){
        OtheruserNotification1 teacherNotification=mNotificationList.get(position);
