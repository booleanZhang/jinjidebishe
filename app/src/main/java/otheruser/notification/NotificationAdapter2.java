...
public class NotificationAdapter2 extends RecyclerView.Adapter<NotificationAdapter2.ViewHolder> {
    ...
    private List<OtheruserNotification2> mNotificationList;
    ...
    public NotificationAdapter2(List<OtheruserNotification2> notificationList){
    ...
    public NotificationAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                OtheruserNotification2 notification=mNotificationList.get(position);
    ...
    public void onBindViewHolder(NotificationAdapter2.ViewHolder holder, int position){
        OtheruserNotification2 teacherNotification=mNotificationList.get(position);
