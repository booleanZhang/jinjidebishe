...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ViewHolder> {
    ...
    private List<TeacherNotification> mNotificationList;
    ...
    public NotificationAdapter(List<TeacherNotification> notificationList){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,int viewType){
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                TeacherNotification notification=mNotificationList.get(position);
    ...
    public void onBindViewHolder(ViewHolder holder,int position){
        TeacherNotification teacherNotification=mNotificationList.get(position);
