...
public class DynamicTeacherClassFragment extends Fragment {
    @BindView(R.id.fragment_dynamic_teacher_class_recyclerview)RecyclerView recyclerView;

    private String TAG="教师班级圈:";
    private String url="http://"+currentUrl+":8888/android_connect/dynamic_teacher.php";

    TeacherActivity teacherActivity;

    DynamicClassAdapter adapter;
    private List<DynamicClass> dynamicClassList;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view= inflater.inflate(R.layout.fragment_dynamic_teacher_class, container, false);
