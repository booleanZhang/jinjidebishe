...
public class FileAdapter extends RecyclerView.Adapter<FileAdapter.ViewHolder>{
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View view){
            ...
            name=(TextView) view.findViewById(R.id.file_teacher_item_name);
            sender=(TextView) view.findViewById(R.id.file_teacher_item_sender);
            dateTime=(TextView) view.findViewById(R.id.file_teacher_item_datetime);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,int viewType){
        ...
        View view= LayoutInflater.from(mContext).inflate(R.layout.file_teacher_item,parent,false);
